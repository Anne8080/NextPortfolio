  ...
  return (
    <div className='py-32' id='projects'>
        <h1 className="heading">
            ...
            <span className="text-purple">past projects</span>
        </h1>
            ...
            {projects.map((project) => (
                <div key={project.id} className="sm:h-[41rem] lg:min-h-[32.5rem] h-[32rem] flex items-center justify-center sm:w-[570px] w-[80vw]">
                    ...
                    <PinContainer title={project.link } href={project.link}>
                        <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[50vh] h-[40vh] mb-10">
                            <div className="relative w-full h-full overflow-hidden lg:rounded-3xl" style={{ backgroundColor: "#13162D" }}>
                                <img src='/bg.png' alt='bgimg' />
                            </div>
                            <img src={project.img} alt={project.title} className='z-10 absolute bottom-0 h-3/4 w-3/4 rounded-t-xl' />
                        </div>
